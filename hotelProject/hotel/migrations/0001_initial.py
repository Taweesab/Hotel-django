...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('customer_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, primary_key=True, serialize=False, to='hotel.customer')),
                ('booking_no', models.CharField(default=hotel.models.Customer_booking.bhID, max_length=11, null=True)),
                ('resb_no', models.CharField(default=hotel.models.Customer_booking.brID, max_length=11, null=True, unique=True)),
